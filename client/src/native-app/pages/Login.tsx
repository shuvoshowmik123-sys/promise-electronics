                ...
                <form onSubmit={handleLogin} className="flex flex-col gap-5 w-full">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="relative flex-1 flex h-14 items-center justify-center gap-3 rounded-full border border-[var(--color-native-border)] bg-[var(--color-native-card)] text-[var(--color-native-text)] font-medium text-base hover:bg-[var(--color-native-input)] active:scale-[0.98] transition-all"
                        >
