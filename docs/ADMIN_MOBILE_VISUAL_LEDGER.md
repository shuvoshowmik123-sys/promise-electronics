...
| Warranty Claims | Patched Needs Retest | 2026-07-03 | `raw/warranty-claims-*.json` + screenshots | Phase 27B: native mobile branch — MobileTabLayout, status chips (All/Pending/Approved/Rejected/Linked), search, cards (Job #originalJobId primary), portaled bottom sheet with approve/reject + rejection reason textarea. Desktop table unchanged. Needs visual QA on 390×844, 430×932, 844×390 landscape. |
